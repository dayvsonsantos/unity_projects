...
public class WordData : MonoBehaviour {
	...
	IEnumerator LoadWordData() {
        ...
        string folder1 = System.IO.Path.Combine("searchWordGame", "searchStreamingAssets");
        string folder = System.IO.Path.Combine(folder1, "new_words.txt");
        ...
        folder1 = System.IO.Path.Combine("searchWordGame", "searchStreamingAssets");
        folder = System.IO.Path.Combine(folder1, "new_words.txt");
